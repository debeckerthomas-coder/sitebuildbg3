...
const SEARCH_DATA_FR: readonly SearchEntry[] = [
  ...
  { id: "t_group", label: "Composition de Groupe", category: "Outil", href: "/outils/groupe", icon: "👥", keywords: "groupe composition party" },
...
const SEARCH_DATA_EN: readonly SearchEntry[] = [
  ...
  { id: "t_group", label: "Party Composition", category: "Tool", href: "/outils/groupe", icon: "👥", keywords: "group party composition" },
